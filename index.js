...
module.exports = postcss.plugin('postcss-svg-fragments', (rawopts) => (css, result) => {
	...
	// plugin options
	const opts = {
		// whether to transpile svg fragments
		fragments:    rawopts && 'fragments' in rawopts    ? Boolean(rawopts.fragments)    : true,
		// whether to transpile svg non-fragments
		nonFragments: rawopts && 'nonFragments' in rawopts ? Boolean(rawopts.nonFragments) : true,
